  ...
  return (
    <div className='min-h-screen bg-gradient-to-b from-red-50 via-white to-red-50 p-4 md:p-8 relative overflow-hidden'>
      ...
      <div className='max-w-5xl mx-auto'>
        {/* Header with logo */}
        <header className='flex flex-col text-center items-center justify-center mb-6'>
          ...
          <p className='text-lg text-gray-700 max-w-2xl mx-auto'>
            Join our life-saving mission to collect blood. Every drop counts.
            Every donor matters.
          </p>

          <Link href='/leaderboard'>
            <p className='bg-red-600 text-white rounded-full w-max self-center px-4 py-2 font-semibold hover:bg-red-700'>
                        ...
                        <rect
                          ...
                          style={{
                            transform: `translateY(${
                              (1 - Math.min(fillPercentage / 100, 1)) * 24
                            }px)`,
        ...
        <footer className='mt-16 pb-8 text-center'>
          ...
          <div className='text-gray-600'>
            <p className='font-medium'>DJS-NSS Blood Donation Drive</p>
            <p className='text-sm mt-1'>
              For inquiries: djsnss2025@gmail.com • {new Date().getFullYear()}
            </p>
          </div>
        </footer>
      </div>
